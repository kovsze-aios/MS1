...
export const companyConfig: CompanyConfig = {
  ...
  contact: {
    ...
    email: 'kontakt@morskiesafari.pl', // TODO: potwierdź adres e-mail
    street: 'ul. Gdańska 104',
    postalCode: '82-103',
    city: 'Mikoszewo',
    region: 'woj. pomorskie',
    directionsHint:
      'Przystań znajduje się przy ujściu Wisły, w pobliżu przeprawy promowej Świbno – Mikoszewo. Dojazd drogą wojewódzką nr 501, parking bezpośrednio przy przystani.',
  ...
  legal: {
    // ⚠️ KOMPLET DANYCH REJESTROWYCH DO UZUPEŁNIENIA.
    // Wartości poniżej są WYŁĄCZNIE zaślepkami utrzymującymi układ strony.
    // Pobierz je z CEIDG/KRS klienta przed publikacją — publikacja błędnych
    // danych rejestrowych to realne ryzyko prawne.
    legalName: 'Morskie Safari', // TODO: pełna nazwa z CEIDG
    nip: '000-000-00-00', // TODO: realny NIP
    regon: '000000000', // TODO: realny REGON
    bankName: 'Nazwa banku', // TODO: nazwa banku
    bankAccount: 'PL00 0000 0000 0000 0000 0000 0000', // TODO: realny numer konta
  },

  google: {
    // TODO: zweryfikuj oba pola w wizytówce Google przed publikacją.
    // Zawyżona ocena wykryta przez klienta kosztuje więcej zaufania,
    // niż zyskuje sama liczba.
    rating: 4.9,
    reviewsCount: 186,
  ...
  theme: {
    ...
    // Zmiana tych trzech wartości przemalowuje OBA warianty strony:
    // przyciski, ikony, obramowania, poświaty i akcenty typograficzne.
    accent: '#0284c7',
    accentDark: '#075985',
  ...
  media: {
    // Plik wgraj do: public/videos/hero.mp4
    // Instrukcja kodowania (klatki kluczowe!) w public/videos/README.md.
  ...
  cruise: {
    durationMinutes: 40,
    maxSpeedKmh: 100,
    departurePoint: 'Przystań Mikoszewo, ujście Wisły',
    routeDescription:
    ...
    maxPassengers: 12, // TODO: potwierdź limit zgodny z dokumentami jednostek
  },
  ...
  tickets: {
    ...
    types: [
      {
        ...
        price: 70,
        icon: 'users',
        // Domyślnie 2 dorosłych — najczęstszy scenariusz rezerwacji.
        defaultQuantity: 2,
        maxQuantity: 12,
      },
      {
    ...
    // 8% — stawka VAT dla usług turystycznych.
    // TODO: potwierdź stawkę z księgowością klienta.
    vatRate: 0.08,
    ctaLabel: 'Zarezerwuj rejs telefonicznie',
    disclaimer:
    ...
    // '' = tryb demo bez zapytań sieciowych.
    // Po uruchomieniu template-api wpisz: 'http://localhost:4000/api/estimate'
    apiEndpoint: '',
  },
